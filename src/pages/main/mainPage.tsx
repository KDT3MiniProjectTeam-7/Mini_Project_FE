        ...
        userState ? 
          <>
            <RecommenSection>
              ...
              <div className={toggleBtn1 ? "showMenu" : undefined}>
                <ContainerBox>
                  <CardContainer>
                    <p>
                      <span>신한은행</span>
            ...
            <RecommenSection>
              ...
              <div className={toggleBtn2 ? "showMenu" : undefined}>
                <SavingsContainer>
            ...
            <RecommenSection>
              ...
              <div className={toggleBtn3 ? "showMenu" : undefined}>
                <LoanContainer>
                    <div>
            ...
            <RecommenSection>
              ...
              <div className={toggleBtn4 ? "showMenu" : undefined}>
